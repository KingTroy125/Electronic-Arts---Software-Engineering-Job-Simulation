...
class Inventory {
private:
    std::vector<std::unique_ptr<Item>> items; // Use vector for dynamic storage
    float total_money;
...
public:
    ...
    void remove_item(size_t item_index) {
        ...
        auto &item = items[item_index]; // Reference to item pointer
        ...
        if (input_quantity <= quantity) {
            ...
            // If quantity reaches zero, remove item from vector
